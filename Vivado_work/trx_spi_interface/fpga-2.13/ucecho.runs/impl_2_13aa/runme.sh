...
HD_PWD='/mnt/IQups/IQups_Projects/iotSDR/Vivado_work/trx_spi_interface/fpga-2.13/ucecho.runs/impl_2_13aa'
cd "$HD_PWD"
...
EAStep vivado -log ucecho.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ucecho.tcl -notrace
