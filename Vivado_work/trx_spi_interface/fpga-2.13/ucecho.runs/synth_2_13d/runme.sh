...
HD_PWD='/mnt/IQups/IQups_Projects/iotSDR/Vivado_work/trx_spi_interface/fpga-2.13/ucecho.runs/synth_2_13d'
cd "$HD_PWD"
...
EAStep vivado -log ucecho.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ucecho.tcl
